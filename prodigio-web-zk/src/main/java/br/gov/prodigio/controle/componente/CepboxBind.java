...
public class CepboxBind extends TextboxBind implements AfterCompose, FieldValidator {
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoCep(this);

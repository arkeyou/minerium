...
public class CheckboxBind extends Checkbox implements AfterCompose, FieldValidator {
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoCheckboxBind(this);
	}

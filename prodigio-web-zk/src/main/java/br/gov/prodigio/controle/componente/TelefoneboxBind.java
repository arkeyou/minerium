...
public class TelefoneboxBind extends TextboxBind implements AfterCompose, FieldValidator {
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoTelefone(this);

...
public class ButtonDownloadBind extends Button implements AfterCompose, FieldValidator {
	...
	private Boolean impAssinaturaPdf;

	@Override
	public void afterCompose() {
		Window window = ProCtr.findWindow(this);
		ProCtr ctr = (ProCtr) window.getAttribute(window.getId() + "$" + "composer");
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoButtonDownloadBind(this);
		setImage("~./imagem/download.png");
	...
	public Boolean isImpAssinaturaPdf() {
		return impAssinaturaPdf;
	}

	public void setImpAssinaturaPdf(Boolean impAssinaturaPdf) {
		this.impAssinaturaPdf = impAssinaturaPdf;
	}

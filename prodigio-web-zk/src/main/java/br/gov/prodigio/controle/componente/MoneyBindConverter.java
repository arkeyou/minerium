...
public class MoneyBindConverter implements TypeConverter {

	@Override
	public Object coerceToBean(Object val, Component comp) {
		if (val != null) {
			String aux = (String) val;
			return StringHelper.strToBigDecimal(aux);
	...
	public Object coerceToUi(Object val, Component comp) {
		if (val != null) {
			BigDecimal aux = (BigDecimal) val;
			return NumberHelper.bigDecimalToStr(aux, Constantes.REAL);
		}
		return null;
	}
}

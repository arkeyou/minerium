...
public class RadiogroupBind extends Radiogroup implements AfterCompose, FieldValidator {

	private static final long serialVersionUID = 7473949596376452570L;
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoRadiogroupBind(this);
	}
	...
	private String converter = "br.gov.prodigio.controle.componente.ProRadiogroupSelectItemConverter";

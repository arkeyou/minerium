...
public class PlacaboxBind extends TextboxBind implements AfterCompose, FieldValidator {
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoPlaca(this);

...
public class CnpjboxBind extends TextboxBind implements AfterCompose, FieldValidator {
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoCnpj(this);

...
public class UploadArquivo extends Hbox implements AfterCompose {

	private static final long serialVersionUID = -1999389270228402968L;
	...
	public void afterCompose() {
		...
		ctr.getProAnnotateDataBinderHelper().adicionaAnotacaoParaCampoUploadArquivo(this);
	}
